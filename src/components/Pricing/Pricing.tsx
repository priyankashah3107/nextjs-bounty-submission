  ...
  return (
    <>
      <div className=" flex flex-col justify-between items-center text-[#0F172A] dark:text-[#F8FAFC] text-start md:text-center mt-44 mb-44">
        <Button
          color="primary"
          className="bg-[#E2E8F0] hover:bg-[#E2E8F0] text-black dark:bg-[#1E293B] dark:hover:bg-[#1E293B] dark:text-white gap-3 rounded-full"
        >
          {' '}
          <DollarSign /> <span>Pricing</span> <ArrowRight />{' '}
        </Button>
        <DummyInfo
          head={'Quality without any compromise'}
          paragraph={
            'CI/CD streamlines feature delivery, scalable infrastructure ensures global'
          }
          parag={
            'edge optimization and app monitoring capabilities for peak site performance.'
          }
        />

        <div className="flex flex-row w-[332px] md:h-12 p-1 bg-slate-100 dark:bg-[#4b576d] rounded-md  justify-between gap-2  ">
          <Button className="w-1/2 bg-white hover:bg-slate-300 text-black dark:bg-[#020817] dark:text-white  ">
            Monthly
          </Button>
          <Button className="w-1/2 bg-slate-100 hover:bg-slate-300 text-black dark:bg-[#1E293B] dark:text-[#94A3B8]">
            Yearly
          </Button>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4 p-4 md:p-8">
        <Card className="w-full md:w-[350px]">
          ...
          <CardContent>
            ...
            <Button className="mt-4 w-full hover:bg-black  bg-[#000000] dark:bg-white dark:text-black text-white">
              Buy now
            </Button>
