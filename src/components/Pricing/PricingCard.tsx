...
const PricingCard = ({ title, price, features, popular }) => {
  return (
    <div
      className={`p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md space-y-4 ${popular ? 'border-2 border-indigo-500' : ''}`}
    >
      <div className="text-center">
        ...
        <button className="w-full bg-indigo-500 text-white py-2 rounded-md mt-4">
          Buy now
        </button>
      </div>
