...
const DummyInfo: React.FC<DummyInfoProps> = ({ head, paragraph, parag }) => {
  return (
    <div className="text-start md:text-center p-6 md:p-0">
      ...
      <P className="text-left md:text-center para paraB md:text-xl font-normal leading-7 mt-2 md:mt-4">
        {paragraph}
      </P>
      <P className="text-left md:text-center para paraB md:text-xl font-normal leading-7 mt-2 md:mt-4 mb-6">
        {parag}
      </P>
    </div>
  );
